	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:mysql://localhost:3306/stage?zeroDateTimeBehavior=CONVERT_TO_NULL&serverTimezone=UTC";
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("select nom from contacts");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-Win32-20200219_1130-V7.3.1/temp/TempGuessSchemaDelimitedFile.csv"))
...
/************************************************************************************************
 * 37715 characters generated by Talend Open Studio for Data Integration on the
 * 3 mars 2021 09:01:00 CET
 ************************************************************************************************/