...
public class TFileInputRawBeginJava
{
  ...
  protected final String TEXT_18 = NL + "\t\t\t\tjava.io.FileInputStream fis_";
  ...
  protected final String TEXT_22 = " = org.apache.commons.io.FileUtils.readFileToString(new java.io.File(";
  protected final String TEXT_23 = "), ";
  protected final String TEXT_24 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_25 = ".";
  protected final String TEXT_26 = " = content_";
  protected final String TEXT_27 = ";";
  protected final String TEXT_28 = NL + "\t\t\t\t\tfis_";
  protected final String TEXT_29 = " = org.apache.commons.io.FileUtils.openInputStream(new java.io.File(";
  protected final String TEXT_30 = "));" + NL + "\t\t\t\t\t";
  protected final String TEXT_31 = " = fis_";
  protected final String TEXT_32 = NL + "\t\t\t\t\tbyte[] content_";
  protected final String TEXT_33 = " = org.apache.commons.io.FileUtils.readFileToByteArray(new java.io.File(";
  protected final String TEXT_34 = "\t\t\t\t\t" + NL + "\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_35 = "_FILENAME_PATH\", ";
  protected final String TEXT_36 = ");" + NL + "\t\t\t\t} catch (java.io.IOException e_";
